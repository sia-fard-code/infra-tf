...
{
	local first_option all_short_options='aspncbgAwvhil'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [-a|--aws-access-key <arg>] [-s|--aws-secret-key <arg>] [-p|--(no-)prod] [-n|--(no-)non-prod] [-c|--common] [-b|--blue] [-g|--green] [-A|--all] [-i|--(no-)init] [-w|--tf-workspace <arg>] [-v|--version] [-h|--help]\n' "$0"
