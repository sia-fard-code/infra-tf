...
module "vmss_api" {
  ...
  color = "blue"
  env = var.env
  computer_name_prefix = "blue-api"
  appgw_backend_pools = {
              appgw-api = {
                appgw_key = "agw-api"
                pool_names = ["dev-blue-api-ag-app"]
              }
            }
}
...
module "vmss_web" {
  ...
  app_name = "web"
  env = var.env
  computer_name_prefix = "blue-web"
  color = "blue"
  appgw_backend_pools = {
              appgw-web = {
                appgw_key = "agw-web"
                pool_names = ["dev-blue-web-ag-app"]
              }
            }
}
...
module "caf" {
  ...
  keyvaults = {
    bastion_kv = {
      ...
      resource_group_key = module.variables.rg["blue"]
      sku_name           = "standard"
      creation_policies = {
        logged_in_user = {
  ...
  networking = {
    ...
    vnet_peerings = {
      common_2_blue = {
        ...
        to = {
          vnet_key = "blue"
          virtual_network_name = "vnet-${var.env}-blue"
          resource_group_name = "rg-${var.env}-blue"
          remote_virtual_network_id = "/subscriptions/${var.subscription}/resourceGroups/rg-dev-blue/providers/Microsoft.Network/virtualNetworks/vnet-dev-blue"
        }
    ...
    public_ip_addresses = {
      ...
      lb_pip_api-int = {
        name                    = "${var.env}-blue-lb-api-int-pip"
        resource_group_key      = module.variables.rg["blue"]
        sku                     = "Standard"
        allocation_method       = "Static"
        ip_version              = "IPv4"
    ...
    bastion_host = {
      ...
      networking_interfaces = {
        nic1 = {
          vnet_key                = "blue"
          subnet_key              = "subnet2"
          name                    = "dev-blue-bastion"
          enable_ip_forwarding    = false
          internal_dns_name_label = "nic1"
          public_ip_address_key   = "blue_bastion_pip"
